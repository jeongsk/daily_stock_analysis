...
def test_dockerfile_bundles_default_alphasift_adapter() -> None:
    ...
    assert "git+https://github.com/ZhuLinsen/alphasift.git@377049857cc04175dc3cca62121ee41adec6cdb8" in requirements
    assert "pip-install-requirements.sh" in dockerfile
