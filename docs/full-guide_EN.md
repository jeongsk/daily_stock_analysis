...
| `/api/v1/portfolio/links/{account_id}/orders/proposals` | GET | List proposals for this linked account, optionally filtered by `status`. |
...
| `/api/v1/portfolio/links/{account_id}/conditional-orders/proposals` | GET | List conditional-order proposals for this linked account, optionally filtered by `status` (v2: this read also requires order-write auth — see notes below). |
